...
export const Header = () => {
    return (
        <header className="mobile-big:py-3 mobile-big:px-4 w-screen text-white  bg-black px-3 py-2 ">
            <nav>
                <ol className="flex items-center gap-2">
                    <li className="flex-grow text-bold">Logo</li>
                    <li className="relative -top-3 w-32 mobile-big:w-40">
                        <div className="flex ">
                            <input type="text" className="absolute w-full rounded-sm border border-gray-200 text-black px-2"/>
                    ...
                    <li>
                        <button className="bg-[#4452CA] p-1 rounded-sm active:relative active:-bottom-1">
                            <svg width="26" height="26" viewBox="0 0 24 29" fill="none" xmlns="http://www.w3.org/2000/svg">
